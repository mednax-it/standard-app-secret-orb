...
export TF_VAR_app_registration_id=$(circleci env subst "${PARAM_APP_REGISTRATION_ID}")
export TF_VAR_resource_group_name=$(circleci env subst "${PARAM_RESOURCE_GROUP_NAME}")
export TF_VAR_key_vault_name=$(circleci env subst "${PARAM_KEY_VAULT_NAME}")
export TF_VAR_key_name=$(circleci env subst "${PARAM_KEY_NAME}")
